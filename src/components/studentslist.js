...
const PersonalInfo = () => {
    ...
    return (
        ...
        <>
            <div>
                <img src="image.jpg" alt="" height="650px" width="100%" />

            </div>
            <div className="container list1 mt-5">
                <div className="row">
                    <div className="col-lg-12 mt-4">
                        <div className="bg-white p-4 rounded tb1">
                                        ...
                                        recordList.filter(val => {
                                            ...
                                            return (
                                                <tr key={userinfo.id}>
                                                    ...
                                                    <Link style={{ textDecoration: 'none' }} to={`/${userinfo.rollNumber}/data`}> {userinfo.studentName} </Link>
